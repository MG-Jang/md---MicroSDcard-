...
class IMGParser:
    ...
    def callback(self, msg):
        ...
        #upper_wlane = np.array([ 180   , 100 , 255   ])
        ...
        '''
        img_wlane = cv2.inRange( img_bgr,lower_wlane, upper_wlane) #white
        # img_wlane = cv2.cvtColor(img_bgr,)  # 색상 공간 변화
        #img_concat = np.concatenate((img_bgr,  img_wlane))
        #TODO: (3)
        '''
        # 이미지를 출력 합니다.
        ...
        '''
        cv2.imshow("Image white", img_wlane)
        cv2.waitKey(1) 
