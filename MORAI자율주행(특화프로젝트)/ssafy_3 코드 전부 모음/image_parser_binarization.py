...
class IMGParser:
    ...
    def callback(self, msg):
        ...
        '''
        img_wlane = cv2.inRange( img_hsv,lower_wlane, upper_wlane) #white
        img_ylane = cv2.inRange( img_hsv,lower_ylane, upper_ylane )  #yellow
        ...
        cv2.imshow("Image combin", img_lane)
        cv2.waitKey(1) 
