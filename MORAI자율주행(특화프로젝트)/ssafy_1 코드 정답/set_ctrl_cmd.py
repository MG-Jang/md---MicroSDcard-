...
# 차량이 ctrl_cmd에 의해 작동됨을 확인하기 위해서는 simulator에서 driving mode를 Automode로 변경시켜 주어야 하며
# 이를 위한 단축키는 q이다
...
def talker():
    ...
    while not rospy.is_shutdown():
        mode = raw_input("Enter Mode[wads] : ")
        ctrlcmdmod = ctrl_cmd_mod(mode)
        rospy.loginfo(ctrlcmdmod)
