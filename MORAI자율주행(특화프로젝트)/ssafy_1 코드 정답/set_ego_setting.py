...
def talker():
    ...
    '''
    ego_setting_msg = MultiEgoSetting()
    ego_setting_msg.number_of_ego_vehicle = 5
    ego_setting_msg.camera_index = 0
    ego_setting_msg.ego_index = range(5)
    ego_setting_msg.global_position_x = range(105,130,5)
    ego_setting_msg.global_position_y = range(1606,1611,1)
    ego_setting_msg.global_position_z = [0,0,0,0,0]
    ego_setting_msg.global_roll = [0,0,0,0,0]
    ego_setting_msg.global_pitch = [0,0,0,0,0]
    ego_setting_msg.global_yaw = [0,0,0,0,0]
    ego_setting_msg.velocity=[0,0,0,0,0]
    ego_setting_msg.gear=[1,1,1,1,1]
    ego_setting_msg.ctrl_mode=[1,16,16,16,16] 
