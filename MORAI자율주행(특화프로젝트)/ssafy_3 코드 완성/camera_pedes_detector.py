...
class PEDESDetector:
    ...
    def callback(self, msg):
        ...
        try:
            ...
            img_bgr = img_bgr[100:400, 120:520].copy()
            #img_bgr = cv2.resize(img_bgr, dsize=(54, 140), interpolation=cv2.INTER_CUBIC)
        ...
        (rects_temp, _) = self.pedes_detector.detectMultiScale(img_gray, winStride=(4, 4), padding=(8, 8), scale=32)
        ...
        if len(rects_temp) != 0:
            ...
            print("no target")
        cv2.imshow("Image dection", img_bgr)
        cv2.waitKey(1)
